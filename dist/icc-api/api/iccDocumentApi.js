...
class iccDocumentApi {
  ...
  findByHCPartyMessageSecretFKeys(hcPartyId, secretFKeys) {
    let _body = null
    const _url =
      this.host +
    ...
    return XHR_1.XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => doc.body.map(it => new models.DocumentDto(it)))
      .catch(err => this.handleError(err))
  }
  ...
  getAttachment(documentId, attachmentId, enckeys, fileName) {
    let _body = null
    const _url =
      this.host +
  ...
  setAttachment(documentId, enckeys, body) {
    let _body = null
    _body = body
    const _url =
      this.host +
  ...
  setAttachmentMulti(documentId, enckeys, attachment) {
    let _body = null
    attachment &&
