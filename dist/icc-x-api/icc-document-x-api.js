...
class IccDocumentXApi extends iccApi_1.iccDocumentApi {
  constructor(
    host,
    headers,
    crypto,
    ...
    this.utiRevDefs = Object.assign({}, this.compatUtiRevDefs, {
  ...
  // noinspection JSUnusedGlobalSymbols
  getAttachmentUrl(documentId, attachmentId, sfks, sessionId, fileName) {
    return (
      this.host +
      `/document/${documentId}/attachment/${attachmentId}${
