...
export class AmpDto  {
  ...
  company?: models.CompanyDto

  abbreviatedName?: models.SamTextDto

  proprietarySuffix?: models.SamTextDto

  prescriptionName?: models.SamTextDto

  ampps?: Array<models.AmppDto>

  components?: Array<models.AmpComponentDto>
...
export namespace AmpDto {
  ...
  export enum MedicineTypeEnum {
    ALLOPATHIC = <any>"ALLOPATHIC",
    HOMEOPATHIC = <any>"HOMEOPATHIC"
  }
}
