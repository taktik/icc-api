...
export class iccMessageApi {
  ...
  findMessagesByFromAddress(fromAddress?: string, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<models.MessagePaginatedList | any> {
    let _body = null
    
    const _url = this.host + "/message/byFromAddress" + "?ts=" + new Date().getTime()  + (fromAddress ? "&fromAddress=" + fromAddress : "") + (startKey ? "&startKey=" + startKey : "") + (startDocumentId ? "&startDocumentId=" + startDocumentId : "") + (limit ? "&limit=" + limit : "") + (hcpId ? "&hcpId=" + hcpId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc =>  new models.MessagePaginatedList(doc.body as JSON))
  ...
  findMessagesByToAddress(toAddress?: string, startKey?: string, startDocumentId?: string, limit?: number, reverse?: boolean, hcpId?: string): Promise<models.MessagePaginatedList | any> {
    let _body = null
    
    const _url = this.host + "/message/byToAddress" + "?ts=" + new Date().getTime()  + (toAddress ? "&toAddress=" + toAddress : "") + (startKey ? "&startKey=" + startKey : "") + (startDocumentId ? "&startDocumentId=" + startDocumentId : "") + (limit ? "&limit=" + limit : "") + (reverse ? "&reverse=" + reverse : "") + (hcpId ? "&hcpId=" + hcpId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc =>  new models.MessagePaginatedList(doc.body as JSON))
  ...
  findMessagesByTransportGuid(transportGuid?: string, received?: boolean, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<models.MessagePaginatedList | any> {
    let _body = null
    
    const _url = this.host + "/message/byTransportGuid" + "?ts=" + new Date().getTime()  + (transportGuid ? "&transportGuid=" + transportGuid : "") + (received ? "&received=" + received : "") + (startKey ? "&startKey=" + startKey : "") + (startDocumentId ? "&startDocumentId=" + startDocumentId : "") + (limit ? "&limit=" + limit : "") + (hcpId ? "&hcpId=" + hcpId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc =>  new models.MessagePaginatedList(doc.body as JSON))
  ...
  findMessagesByTransportGuidSentDate(transportGuid?: string, from?: number, to?: number, startKey?: string, startDocumentId?: string, limit?: number, hcpId?: string): Promise<models.MessagePaginatedList | any> {
    let _body = null
    
    const _url = this.host + "/message/byTransportGuidSentDate" + "?ts=" + new Date().getTime()  + (transportGuid ? "&transportGuid=" + transportGuid : "") + (from ? "&from=" + from : "") + (to ? "&to=" + to : "") + (startKey ? "&startKey=" + startKey : "") + (startDocumentId ? "&startDocumentId=" + startDocumentId : "") + (limit ? "&limit=" + limit : "") + (hcpId ? "&hcpId=" + hcpId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc =>  new models.MessagePaginatedList(doc.body as JSON))
  ...
  setMessagesReadStatus(body?: models.MessagesReadStatusUpdate): Promise<Array<models.MessageDto> | any> {
    let _body = null
    _body = body
