...
export class iccCalendarItemApi {
  ...
  getCalendars(startDate?: number, endDate?: number, hcPartyId?: string): Promise<Array<models.CalendarItemDto> | any> {
    let _body = null
  ...
  getCalendarsByPeriodAndAgendaId(startDate?: number, endDate?: number, agendaId?: string): Promise<any | Boolean> {
    let _body = null
