...
export class iccMedicalLocationApi {
  ...
  createMedicalLocation(body?: models.MedicalLocationDto): Promise<models.MedicalLocationDto | any> {
    let _body = null
    _body = body
  ...
  deleteMedicalLocation(locationIds: string): Promise<any | Boolean> {
    ...
    const _url = this.host + "/medicallocation/{locationIds}".replace("{locationIds}", locationIds+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
  ...
  getMedicalLocation(locationId: string): Promise<models.MedicalLocationDto | any> {
    ...
    const _url = this.host + "/medicallocation/{locationId}".replace("{locationId}", locationId+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
  ...
  modifyMedicalLocation(body?: models.MedicalLocationDto): Promise<models.MedicalLocationDto | any> {
    let _body = null
    _body = body
