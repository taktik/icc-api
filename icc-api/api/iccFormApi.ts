...
export class iccFormApi {
  ...
  deleteForms(formIds: string): Promise<Array<string> | any> {
    ...
    const _url = this.host + "/form/{formIds}".replace("{formIds}", formIds+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("DELETE", _url, headers, _body, this.fetchImpl)
  ...
  findDelegationsStubsByHCPartyPatientSecretFKeys(hcPartyId?: string, secretFKeys?: string): Promise<Array<models.IcureStubDto> | any> {
    ...
    const _url = this.host + "/form/byHcPartySecretForeignKeys/delegations" + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + hcPartyId : "") + (secretFKeys ? "&secretFKeys=" + secretFKeys : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
  ...
  findFormTemplates(loadLayout?: boolean): Promise<Array<models.FormTemplateDto> | any> {
    ...
    const _url = this.host + "/form/template" + "?ts=" + new Date().getTime()  + (loadLayout ? "&loadLayout=" + loadLayout : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
  ...
  findFormTemplatesBySpeciality(specialityCode: string, loadLayout?: boolean): Promise<Array<models.FormTemplateDto> | any> {
    let _body = null
    
    const _url = this.host + "/form/template/bySpecialty/{specialityCode}".replace("{specialityCode}", specialityCode+"") + "?ts=" + new Date().getTime()  + (loadLayout ? "&loadLayout=" + loadLayout : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.FormTemplateDto(it)))
  ...
  setAttachmentMulti(formTemplateId: string, attachment?: Array<string>): Promise<string | any> {
    ...
    const _url = this.host + "/form/template/{formTemplateId}/attachment/multipart".replace("{formTemplateId}", formTemplateId+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
