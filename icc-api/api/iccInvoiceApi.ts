...
export class iccInvoiceApi {
  ...
  appendCodes(userId: string, type: string, sentMediumType: string, insuranceId?: string, secretFKeys?: string, invoiceId?: string, gracePriod?: number, body?: Array<models.InvoicingCodeDto>): Promise<Array<models.InvoiceDto> | any> {
    let _body = null
    _body = body
    
    const _url = this.host + "/invoice/byauthor/{userId}/append/{type}/{sentMediumType}".replace("{userId}", userId+"").replace("{type}", type+"").replace("{sentMediumType}", sentMediumType+"") + "?ts=" + new Date().getTime()  + (insuranceId ? "&insuranceId=" + insuranceId : "") + (secretFKeys ? "&secretFKeys=" + secretFKeys : "") + (invoiceId ? "&invoiceId=" + invoiceId : "") + (gracePriod ? "&gracePriod=" + gracePriod : "")
  ...
  findByAuthor(hcPartyId: string, fromDate?: number, toDate?: number, startKey?: string, startDocumentId?: string, limit?: number): Promise<models.InvoicePaginatedList | any> {
    let _body = null
    
    const _url = this.host + "/invoice/byauthor/{hcPartyId}".replace("{hcPartyId}", hcPartyId+"") + "?ts=" + new Date().getTime()  + (fromDate ? "&fromDate=" + fromDate : "") + (toDate ? "&toDate=" + toDate : "") + (startKey ? "&startKey=" + startKey : "") + (startDocumentId ? "&startDocumentId=" + startDocumentId : "") + (limit ? "&limit=" + limit : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
  ...
  findDelegationsStubsByHCPartyPatientSecretFKeys(hcPartyId?: string, secretFKeys?: string): Promise<Array<models.IcureStubDto> | any> {
    let _body = null
    
    const _url = this.host + "/invoice/byHcPartySecretForeignKeys/delegations" + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + hcPartyId : "") + (secretFKeys ? "&secretFKeys=" + secretFKeys : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
  ...
  getTarificationsCodesOccurences(minOccurences: number): Promise<Array<models.LabelledOccurenceDto> | any> {
    let _body = null
    
    const _url = this.host + "/invoice/codes/{minOccurences}".replace("{minOccurences}", minOccurences+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
  ...
  listByHcPartyGroupId(hcPartyId: string, groupId: string): Promise<Array<models.InvoiceDto> | any> {
    ...
    const _url = this.host + "/invoice/byHcPartyGroupId/{hcPartyId}/{groupId}".replace("{hcPartyId}", hcPartyId+"").replace("{groupId}", groupId+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.InvoiceDto(it)))
  ...
  listByHcPartySentMediumTypeInvoiceTypeSentDate(hcPartyId: string, sentMediumType: "cdrom" | "eattest" | "efact" | "email" | "mediprima" | "paper" | "technicalAct", invoiceType: "patient" | "mutualfund" | "payingagency" | "insurance" | "efact" | "other", sent: boolean, from?: number, to?: number): Promise<Array<models.InvoiceDto> | any> {
    let _body = null
    
    const _url = this.host + "/invoice/byHcParty/{hcPartyId}/mediumType/{sentMediumType}/invoiceType/{invoiceType}/sent/{sent}".replace("{hcPartyId}", hcPartyId+"").replace("{sentMediumType}", sentMediumType+"").replace("{invoiceType}", invoiceType+"").replace("{sent}", sent+"") + "?ts=" + new Date().getTime()  + (from ? "&from=" + from : "") + (to ? "&to=" + to : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.InvoiceDto(it)))
  ...
  listByHcpartySendingModeStatusDate(hcPartyId: string, sendingMode?: string, status?: string, from?: number, to?: number): Promise<Array<models.InvoiceDto> | any> {
    let _body = null
    
    const _url = this.host + "/invoice/byHcpartySendingModeStatusDate/{hcPartyId}".replace("{hcPartyId}", hcPartyId+"") + "?ts=" + new Date().getTime()  + (sendingMode ? "&sendingMode=" + sendingMode : "") + (status ? "&status=" + status : "") + (from ? "&from=" + from : "") + (to ? "&to=" + to : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.InvoiceDto(it)))
  ...
  listToPatients(hcPartyId?: string): Promise<Array<models.InvoiceDto> | any> {
    ...
    const _url = this.host + "/invoice/toPatients" + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + hcPartyId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.InvoiceDto(it)))
  ...
  listToPatientsUnsent(hcPartyId?: string): Promise<Array<models.InvoiceDto> | any> {
    ...
    const _url = this.host + "/invoice/toPatients/unsent" + "?ts=" + new Date().getTime()  + (hcPartyId ? "&hcPartyId=" + hcPartyId : "")
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
    return XHR.sendCommand("GET", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.InvoiceDto(it)))
