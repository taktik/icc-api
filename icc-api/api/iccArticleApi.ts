...
export class iccArticleApi {
  ...
  deleteArticle(articleIds: string): Promise<any | Boolean> {
    ...
    const _url = this.host + "/article/{articleIds}".replace("{articleIds}", articleIds+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
  ...
  getArticle(articleId: string): Promise<models.ArticleDto | any> {
    ...
    const _url = this.host + "/article/{articleId}".replace("{articleId}", articleId+"") + "?ts=" + new Date().getTime() 
    let headers = this.headers
    headers = headers.filter(h => h.header !== "Content-Type").concat(new XHR.Header("Content-Type", "application/json"))
