...
export class iccBeMikronoApi {
  ...
  appointmentsByPatient(patientId: string, from?: number, from2?: number): Promise<Array<models.AppointmentDto> | any> {
    let _body = null
  ...
  createAppointmentTypes(body?: Array<models.MikronoAppointmentTypeRestDto>): Promise<Array<models.MikronoAppointmentTypeRestDto> | any> {
    let _body = null
    _body = body
    ...
    return XHR.sendCommand("POST", _url, headers, _body, this.fetchImpl)
      .then(doc => (doc.body as Array<JSON>).map(it => new models.MikronoAppointmentTypeRestDto(it)))
      .catch(err => this.handleError(err))
}
  createAppointments(body?: Array<models.AppointmentImportDto>): Promise<Array<models.AppointmentImportDto> | any> {
    let _body = null
    _body = body
